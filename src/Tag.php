...
/**
 * Primitive class to represent SMPP optional params, also known as TLV (Tag-Length-Value) params
...
class Tag
{
	 ...
	 */
	public function __construct (int $id, string $value, ?int $length = null, string $type = 'a*')
	{
		$this->id = $id;
		$this->value = $value;
		$this->length = $length;
